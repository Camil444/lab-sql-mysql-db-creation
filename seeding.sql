INSERT INTO cars (`id`, `identification_number`, `manufacturer`, `model`, `year`, `color`) 
VALUES 
...
INSERT INTO customers (`id`, `customer_id`, `name`, `phone_number`, `email`, `adress`, `city`, `state`, `country`, `zip_code`) 
VALUES 
